...
class Vector3StampedWrapper {
  ...
  set vector(value) {
    if (value instanceof Vector3Wrapper) {
      ...
      this._wrapperFields.vector.copy(new Vector3Wrapper(value));
    }
  }
...
class Vector3StampedArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof Vector3StampedWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new Vector3StampedWrapper(value);
      }
    });
  }
