...
class Int32MultiArrayWrapper {
  ...
  freeze(own = false, checkConsistency = false) {
    ...
    if (own) {
      this._wrapperFields.data.fill(Int32Array.from([]));
      this._wrapperFields.data.freeze(own, checkConsistency);
      this._refObject.data = this._wrapperFields.data.refObject;
    }
  }
  ...
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"layout","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"std_msgs","type":"MultiArrayLayout","stringUpperBound":null,"isPrimitiveType":false},"default_value":null},{"name":"data","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"int32","stringUpperBound":null,"isPrimitiveType":true},"default_value":null}],"baseType":{"pkgName":"std_msgs","type":"Int32MultiArray","stringUpperBound":null,"isPrimitiveType":false},"msgName":"Int32MultiArray"};
  }
  hasMember(name) {
...
class Int32MultiArrayArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof Int32MultiArrayWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new Int32MultiArrayWrapper(value);
      }
    });
  }
