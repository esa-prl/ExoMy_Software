...
class InertiaStampedWrapper {
  ...
  set inertia(value) {
    if (value instanceof InertiaWrapper) {
      this._wrapperFields.inertia.copy(value);
    } else {
      this._wrapperFields.inertia.copy(new InertiaWrapper(value));
    }
  }
  ...
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"header","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"std_msgs","type":"Header","stringUpperBound":null,"isPrimitiveType":false},"default_value":null},{"name":"inertia","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"geometry_msgs","type":"Inertia","stringUpperBound":null,"isPrimitiveType":false},"default_value":null}],"baseType":{"pkgName":"geometry_msgs","type":"InertiaStamped","stringUpperBound":null,"isPrimitiveType":false},"msgName":"InertiaStamped"};
  }
  hasMember(name) {
...
class InertiaStampedArrayWrapper {
  ...
  fill(values) {
    ...
    values.forEach((value, index) => {
      if (value instanceof InertiaStampedWrapper) {
        this._wrappers[index].copy(value);
      } else {
        this._wrappers[index] = new InertiaStampedWrapper(value);
      }
    });
  }
